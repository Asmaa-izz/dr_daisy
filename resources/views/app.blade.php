            ...
            <div class="u-custom-menu u-nav-container">
                <ul class="u-nav u-spacing-30 u-unstyled u-nav-1">
                    <li class="u-nav-item"><a
                            ...
                            href="{{ route('home') }}" style="padding: 6px 36px;">Home</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-border-2 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-2-dark-1 u-text-hover-palette-2-dark-1 u-text-white"
                            href="{{ route('doctors') }}" style="padding: 6px 36px;">Doctors</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-border-2 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-2-dark-1 u-text-hover-palette-2-dark-1 u-text-white"
                            href="{{ route('hosts') }}" style="padding: 6px 36px;">Hosts</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-border-2 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-2-dark-1 u-text-hover-palette-2-dark-1 u-text-white"
                            href="{{ route('contact-us') }}" style="padding: 6px 36px;">Contact us</a>
                    </li>
                    @if(Auth::check())
                        <li class="u-nav-item">
                    ...
                    <li class="u-nav-item"><a
                            class="u-border-2 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-2-dark-1 u-text-hover-palette-2-dark-1 u-text-white"
                            href="{{ route('sign_in') }}" style="padding: 6px 36px;">Sign in</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-border-2 u-border-active-white u-border-hover-white u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-2-dark-1 u-text-hover-palette-2-dark-1 u-text-white"
                            href="{{ route('sign_up') }}" style="padding: 6px 36px;">Sign up</a>
                    </li>
                    @endif
                </ul>
            </div>
                ...
                <div
                    ...
                    <div class="u-inner-container-layout u-sidenav-overflow">
                        ...
                        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                            ...
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('doctors') }}">Doctors</a>
                            </li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('hosts') }}">Hosts</a>
                            </li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                            ...
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('sign_up') }}">Sign
                                    up</a>
                            </li>
                            @endif
                        </ul>
